    ...
    <section className="features">
      ...
      <div className="features__content">
        ...
        <div className="features__bottom">
          <p className="features__details">
            Voyagers Haven is nestled along the picturesque coastline of
            privateers cove, Nova Scotia. Check-in is available any time after
            3PM and Check-out is at 11:00AM.
          </p>

          <p className="features__details">
            For your convenience, we offer 24-hour self-check-in using a
            personalized lockbox/keypad code provided before your arrival. Enjoy
            nearby hiking trails, kayaking adventures, or simply relax in the
            peaceful surroundings. Free parking is available on site.
          </p>
        </div>
      </div>
    </section>
